...
const IndexPage = () => (
    <Layout>
        <main>
            <SEO title={"August - Persona 5 Royal"}/>
            <div>
                <h2>August</h2>
            </div>
            <div className="day">
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li>Justice Rank 4 <strong>(Jazz Club unlocked)</strong><ol>
                        <li>-</li>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Charm)</strong></li>
                    <li>Devil Rank 3 <strong>(Charm +4)</strong><ol>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Work at convenience store <strong>(Charm +7)</strong> <strong>(Request "Calling for Justice for Cats" unlocked)</strong><ol>
                        <li>Memorize positions of barcodes</li></ol></li>
                </ul>
                <h4>Evening</h4>
                <ul>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Work at flower shop <strong>(Kindness +7)</strong><ol>
                        <li>Scarlet Rose</li>
                        <li>Gold Gerbera</li>
                        <li>Gecko Orchid</li></ol></li>
                </ul>
                <h4>Evening</h4>
                <ul>
                    <li>Rain</li>
            ...
            <div className="day">
                ...
                <ul>
                    <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Kindness)</strong></li>
                    <li>Watch movies in Shibuya <strong>(Kindness +10)</strong> <strong>(Kindness Lv. 4)</strong></li>
                </ul>
                <h4>Evening</h4>
                <ul>
                    <li>Rain</li>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li><strong>[Normal Route]</strong> Devil Rank 5<ol>
                        <li>-</li>
                        <li>-</li>
                        <li>-</li>
                    ...
                    <li><strong>[Battle Route]</strong> Billiards <strong>(Random Stat +3)</strong> <strong>(Technical Lv. 3)</strong> <strong>(Obtain "Billiards Magician")</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Sat 8/13</h3>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Kindness)</strong></li>
                    <li>Work at flower shop <strong>(Kindness +4)</strong> <strong>(Request "Who's Been Assaulting People?" unlocked)</strong></li>
                </ul>
                <h4>Evening</h4>
                <ul>
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li><strong>[Normal Route]</strong> Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Devil +2)</strong></li>
                    <li><strong>[Normal Route]</strong> Devil Rank 6<ol>
                        <li>-</li>
                    ...
                    <li><strong>[Battle Route]</strong> Devil Rank 5<ol>
                        <li>-</li>
                        <li>-</li>
                        <li>-</li>
                        <li>Choice 2: "That's unforgivable." (+3)</li>
            ...
            <div className="day">
                ...
                <ul>
                    <li>Rain</li>
                    <li><strong>[Normal Route]</strong> Devil Rank 7 <strong>(Charm +5)</strong><ol>
                        <li>-</li>
                    ...
                    <li><strong>[Battle Route]</strong> Darts with any two party members <strong>(Proficiency +5)</strong><ol>
                        ...
                        <li>Let your game 2 partner finish on round 4 <strong>(Baton Pass Lv. 3)</strong></li></ol></li>
                </ul>
            </div>
            <div className="day">
                <h3>Sat 8/20</h3>
                ...
                <h4>Evening</h4>
                <ul>
                    <li>Hanged Rank 3 <strong>(Proficiency +3)</strong> <strong>(Battle Route Proficiency Lv. 5)</strong><ol>
                        <li>-</li>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li><strong>[Normal Route]</strong> Watch "31" <strong>(Guts +5)</strong> <strong>(Normal Route Guts Lv. 5)</strong></li>
                    <li><strong>[Battle Route]</strong> Finish reading "Billiards Magician" <strong>(Masse Shot unlocked)</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Mon 8/22</h3>
                ...
                <ul>
                    ...
                    <li>Check Summer Mammoth lottery results <strong>(Does not unlock "Easy Money", only weekly or daily prizes do)</strong></li>
                    <li><strong>[Normal Route]</strong> Devil Rank 7.1 <strong>(Request "Fighting for Truth of Journalism" unlocked)</strong><ol>
                        <li>Choice 2: "You seem tired." (+2)</li>
                        <li>-</li></ol></li>
                    <li><strong>[Battle Route]</strong> Work at bar <strong>(Kindness +3)</strong> <strong>(Request "We Aren't Just Your Slaves" unlocked)</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Tue 8/23</h3>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Star Rank 4 <strong>(Jinbocho unlocked)</strong><ol>
            ...
            <div className="day">
                ...
                <ul>
                    <li>Rain</li>
                    <li><strong>[Normal Route]</strong> Work at bar <strong>(Kindness +3)</strong> <strong>(Request "We Aren't Just Your Slaves" unlocked)</strong></li>
                    <li><strong>[Battle Route]</strong> Billiards <strong>(Random Stat +3)</strong> <strong>(Technical Lv. 4)</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Sat 8/27</h3>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Hanged +2)</strong></li>
                    <li>Star Hangout Inokashira <strong>(If Star Rank 6 available, Free Time)</strong><ol>
