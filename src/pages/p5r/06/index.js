...
export default function IndexPage() {
    return (
        <Layout>
            <main>
                <SEO override={"June - Persona 5 Royal"}/>
                <div>
                    <div>
                        <h2>June</h2>
                    </div>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Hierophant Rank 4 <strong>(Kindness +3)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li>Question: "The number of legs." <strong>(Knowledge +2)</strong> <strong>(Knowledge Lv. 3)</strong></li>
                        </ul>
                        <h4>Daytime</h4>
                        <ul>
                            <li>Rain</li>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li><strong>[Normal Route]</strong> Order Surprise Sando at diner <strong>(Knowledge +2, Guts +2)</strong></li>
                            <li><strong>[Battle Route]</strong> Play darts with any two party members in Kichijoji <strong>(Proficiency +5)</strong> <strong>(Battle Route Proficiency Lv. 3)</strong><ol>
                                <li>Score 180 in round 1 of game 1<ul>
                                    <li>3 triple 20's</li>
                                    <li>Use X to throw dart instead of motion controls</li></ul></li>
                                <li>Let your game 1 partner finish on round 4 <strong>(Baton Pass Lv. 3)</strong><ul>
                                    ...
                                    <li>Empress: Choice 3: "Have fun with it."</li></ul></li>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li><strong>[Normal Route]</strong> Order Surprise Sando at diner <strong>(Knowledge +2, Guts +2)</strong></li>
                            <li><strong>[Battle Route]</strong> Play billiards in Kichijoji <strong>(Random Stat +3)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Fri 6/10</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Rain</li>
                            <li><strong>[Battle Route]</strong> Buy "Expert Billiards" <strong>(Y3500)</strong> from sports shop</li>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li><strong>[Normal Route]</strong> Finish reading "The Art of Charm" <strong>(Charm +5)</strong></li>
                            <li><strong>[Battle Route]</strong> Finish reading "Expert Billiards" <strong>(Technical Lv. 1)</strong></li>
                        </ul>
                        <h4>Evening</h4>
                        <ul>
                            <li>Rain</li>
                            ...
                            <li><strong>[Battle Route]</strong> Billiards <strong>(Random Stat +3)</strong> <strong>(Technical Lv. 2)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Fri 6/17</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Save for crafting reload</li>
                            <li>Reload crafting for <strong>(Proficiency +5)</strong> <strong>(Normal Route Proficiency Lv. 3)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Mon 6/20</h3>
                        ...
                        <ul>
                            ...
                            <li><strong>[Battle Route]</strong> Finish reading "Vague" <strong>(Harajuku unlocked)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Tue 6/21</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Buy "The Craft of Cinema", "Flowerpedia", and "ABCs of Crafting" from Shinjuku bookstore</li>
                            <li>Feed plant Mega Fertilizer <strong>(Kindness +5)</strong> <strong>(Kindness Lv. 3)</strong></li>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li><strong>[Normal Route]</strong> Finish reading "Flowerpedia" <strong>(Provides flower hints during flower shop job)</strong></li>
                            <li><strong>[Battle Route]</strong> Finish reading "The Art of Charm" <strong>(Charm +5)</strong></li>
                        </ul>
                        <h4>Daytime</h4>
                        <ul>
                    ...
                    <div className="day">
                        ...
                        <h4>Daytime</h4>
                        <ul>
                            <li>Lovers Hangout Harajuku <strong>(If Lovers Rank 8 available, Free Time)</strong><ol>
                    ...
                    <div>
                        <Link to="/p5r/07">Go to July</Link>
                    </div>
                </div>
            </main>
        </Layout>
