...
export default function IndexPage() {
    return (
        <Layout>
            <main>
                <SEO override={"January - Persona 5 Royal"}/>
                <div>
                    <div>
                        <h2>January</h2>
                    </div>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Rain</li>
                            <li>Darts with Faith <strong>(Proficiency +3)</strong><ol>
                                <li>Let your partner finish on round 4 <strong>(Baton Pass Lv. 3)</strong></li>
                                <li>Choice 3: "Trust your instincts." <strong>(Faith +1)</strong></li></ol></li>
                        </ul>
                        <h4>Evening</h4>
                        <ul>
                            <li>Free Time</li>
                    ...
                    <div>
                        <Link to="/p5r/02">Go to February</Link>
                    </div>
                </div>
            </main>
        </Layout>
