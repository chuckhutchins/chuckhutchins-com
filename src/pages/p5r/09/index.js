...
const IndexPage = () => (
    <Layout>
        <main>
            <SEO title={"September - Persona 5 Royal"}/>
            <div>
                <h2>September</h2>
            </div>
            <div className="day">
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Interact with desk in your room, Repair laptop <strong>(Proficiency +7)</strong> <strong>(Normal Route Proficiency Lv. 5)</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Sat 9/3</h3>
                ...
                <ul>
                    ...
                    <li>Talk to Akechi in Leblanc, Justice Rank 6<ol>
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li>Hierophant Rank 5 <strong>(Kindness +3)</strong><ol>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li><strong>Mementos Palace</strong><ol>
                        ...
                        <li>Winners Don't Use Cheats, attempt needed to unlock Tower Rnk 1</li></ol></li>
                </ul>
            </div>
            <div className="day">
                <h3>Wed 9/7</h3>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Visit Kichijoji info stand, Ask the receptionist every question <strong>(Knowledge +3)</strong></li>
                ...
                <ul>
                    ...
                    <li>Star Rank 6 <strong>(Knowledge +3)</strong><ol>
            ...
            <div className="day">
                ...
                <h4>Daytime</h4>
                <ul>
                    <li>Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Star +2)</strong></li>
                    <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Guts)</strong></li>
                    <li>Send calling card</li>
                </ul>
                <h4>Evening</h4>
                <ul>
                    <li>Finish reading "Master Swordsman" <strong>(Guts +10)</strong> <strong>(Battle Route Guts Lv. 5)</strong></li>
                </ul>
            </div>
            <div className="day">
                <h3>Wed 9/21</h3>
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li>TV Quiz: "Ten years in prison." <strong>(Knowledge +2)</strong> <strong>(Knowledge Lv. 5)</strong></li>
                    <li>Hierophant Rank 6 <strong>(Kindness +7)</strong> <strong>(Kindness Lv. 5)</strong><ol>
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li><strong>[Normal Route]</strong> Devil Rank 8 <strong>(Charm +5)</strong><ol>
                        <li>-</li>
                        <li>-</li>
                        <li>-</li>
                        <li>Choice 3: <strong>"I'll go with you"</strong> (+3)</li>
                        <li>(Phone) Choice 1: "Good luck." (+2)</li></ol></li>
                    <li><strong>[Battle Route]</strong> Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Devil +2)</strong></li>
                    <li><strong>[Battle Route]</strong> Devil Rank 6<ol>
                        <li>-</li>
            ...
            <div className="day">
                ...
                <ul>
                    ...
                    <li>Death Rank 8 <strong>(Guts +2)</strong><ol>
                        <li>-</li>
            ...
            <div className="day">
                ...
                <h4>Evening</h4>
                <ul>
                    <li><strong>[Normal Route]</strong> Devil Rank 9 Friendship<ol>
                        <li>-</li>
                    ...
                    <li><strong>[Normal Route]</strong> Devil Rank 9 Romance<ol>
                        <li>-</li>
                        <li>Choice 2: "You're not giving up, are you?" (+2)</li>
                        <li>Choice 1: <strong>"I can't leave you."</strong> (+3)</li>
                        <li>-</li>
                    ...
                    <li><strong>[Battle Route]</strong> Devil Rank 7 <strong>(Charm +5)</strong><ol>
                        <li>-</li>
            ...
            <div>
                <Link to="/p5r/10">Go to October</Link>
            </div>
        </main>
    </Layout>
)
