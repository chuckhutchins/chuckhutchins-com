...
export default function IndexPage() {
    return (
        <Layout>
            <main>
                <SEO override={"November - Persona 5 Royal"}/>
                <div>
                    <div>
                        <h2>November</h2>
                    </div>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li><strong>[Battle Route]</strong> Devil Rank 8 <strong>(Charm +5)</strong><ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Talk to Akechi to initiate solo battle, Justice Rank 8<ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li><strong>[Normal Route]</strong> Free Time</li>
                            <li><strong>[Battle Route]</strong> Empress Hangout Asakusa<ol>
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Hanged Rank 8 <strong>(Proficiency +5)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Star Rank 8 <strong>(Knowledge +2)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Star Hangout Jinbocho <strong>(If Star Rank 9 available, Free Time)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li><strong>[Normal Route]</strong> Free Time</li>
                            <li><strong>[Battle Route]</strong> Devil Rank 9 Friendship<ol>
                                <li>-</li>
                            ...
                            <li><strong>[Battle Route]</strong> Devil Rank 9 Romance<ol>
                                <li>-</li>
                                <li>Choice 2: "You're not giving up, are you?" (+2)</li>
                                <li>Choice 1: <strong>"I can't leave you."</strong> (+3)</li>
                                <li>-</li>
                    ...
                    <div>
                        <Link to="/p5r/12">Go to December</Link>
                    </div>
                </div>
            </main>
        </Layout>
