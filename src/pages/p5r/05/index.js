...
export default function IndexPage() {
    return (
        <Layout>
            <main>
                <SEO override={"May - Persona 5 Royal"}/>
                <div>
                    <div>
                        <h2>May</h2>
                    </div>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Reload crafting for <strong>(Proficiency +5)</strong> <strong>(Proficiency Lv. 2)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Tue 5/3</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Feed plant Bio Nutrients <strong>(Kindness +3)</strong> <strong>(Kindness Lv. 2)</strong></li>
                    ...
                    <div className="day">
                        ...
                        <h4>Daytime</h4>
                        <ul>
                            <li>Talk to Ann in 2D classroom, Lovers Rank 2 <strong>(Requires Kindness Lv. 2)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Save for crafting reload</li>
                            <li><strong>[Normal Route]</strong> Clean Leblanc with matching arcana <strong>(Kindness +2)</strong> <strong>(Hierophant +1)</strong></li>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Chariot Rank 5 <strong>(Unlocks Shibuya Gym)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li>Question: "The Heian Period." <strong>(Knowledge +2)</strong> <strong>(Knowledge Lv. 2)</strong></li>
                        </ul>
                        <h4>Daytime</h4>
                        <ul>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li><strong>[Normal Route]</strong> Finish reading "Vague" <strong>(Harajuku unlocked)</strong></li>
                            <li><strong>[Battle Route]</strong> Clean Leblanc with matching arcana <strong>(Kindness +2)</strong> <strong>(Hierophant +1)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Wed 5/25</h3>
                        ...
                        <ul>
                            ...
                            <li>Investigate Yongen-Jaya by talking with residents to ID target <strong>(Request "If Cats Disappeared from the City" unlocked)</strong></li>
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Visit Big Bang Burger on Shibuya central street, Big Bang Challenge <strong>(Charm +2, Proficiency +2, Guts +2, Knowledge +2)</strong> <strong>(Charm Lv. 3)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Thu 5/26</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Visit diner on Shibuya central street, Order Surprise Sando at diner <strong>(Knowledge +2, Guts +2)</strong> <strong>(Guts Lv. 3)</strong></li>
                        </ul>
                        <h4>Evening</h4>
                        <ul>
                    ...
                    <div className="day">
                        ...
                        <h4>Daytime</h4>
                        <ul>
                            <li>Lovers Hangout Inokashira<ol>
                                <li>Choice 3: "Let's just enjoy the air." (+3)</li></ol></li>
                        </ul>
                        <h4>Evening</h4>
                        <ul>
