...
export default function IndexPage() {
    return (
        <Layout>
            <main>
                <SEO override={"July - Persona 5 Royal"}/>
                <div>
                    <div>
                        <h2>July</h2>
                    </div>
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Buy Mammoth Summer lottery ticket <strong>(Y5000)</strong> from Shibuya <strong>(Does not unlock "Easy Money", only weekly or daily prizes do)</strong></li>
                            <li>Lovers Rank 8<ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li>Finish reading "The Great Thief" <strong>(Knowledge +5)</strong> <strong>(Normal Route Knowledge Lv. 4)</strong></li>
                        </ul>
                        <h4>All Day</h4>
                        <ul>
                            <li>Rain</li>
                    ...
                    <div className="day">
                        ...
                        <h4>Evening</h4>
                        <ul>
                            <li>Ask Chihaya for a Luck Reading <strong>(Y5000)</strong> <strong>(Boost Kindness)</strong></li>
                    ...
                    <div className="day">
                        ...
                        <h4>Class</h4>
                        <ul>
                            <li>Question: "A triangle." <strong>(Knowledge +2)</strong> <strong>(Battle Route Knowledge Lv. 4)</strong></li>
                        </ul>
                        <h4>Evening</h4>
                        <ul>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            ...
                            <li>Watch "The Running Dead" <strong>(Guts +5)</strong> <strong>(Normal Route Guts Lv. 4)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Mon 7/11</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Finish watching "The Running Dead" <strong>(Guts +5)</strong> <strong>(Battle Route Guts Lv. 4)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Tue 7/19</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Finish watching "Jail Break" <strong>(Proficiency +5)</strong> <strong>(Battle Route Proficiency Lv. 4)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Sun 7/24</h3>
                    ...
                    <div className="day">
                        ...
                        <ul>
                            <li>Cannot leave Leblanc</li>
                            <li>Save for crafting reload</li>
                            <li>Reload crafting for <strong>(Proficiency +5)</strong> <strong>(Normal Route Proficiency Lv. 4)</strong></li>
                        </ul>
                    </div>
                    <div className="day">
                        <h3>Tue 7/26</h3>
                    ...
                    <div className="day">
                        ...
                        <h4>Daytime</h4>
                        <ul>
                            <li>Justice Hangout Shinagawa <strong>(Shinagawa unlocked)</strong> <strong>(Devil +3)</strong><ol>
                    ...
                    <div className="day">
                        ...
                        <h4>Daytime</h4>
                        <ul>
                            <li>Ask Chihaya for Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Chariot +2)</strong></li>
                            <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Charm)</strong></li>
                    ...
                    <div>
                        <Link to="/p5r/08">Go to August</Link>
                    </div>
                </div>
            </main>
        </Layout>
